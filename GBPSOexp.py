...
if __name__ == "__main__":
    ...
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GlobalBestPSO(n_particles=num_particles, dimensions=2, options={'c1': i, 'c2': 0.5, 'w': 0.5})
    ...
    fig, ax = plt.subplots()
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GlobalBestPSO(n_particles=num_particles, dimensions=2, options={'c1': 0.5, 'c2': i, 'w': 0.5})
        optimizer.optimize(goldstein_price, iters=num_iterations)
    ...
    fig, ax = plt.subplots()
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GlobalBestPSO(n_particles=num_particles, dimensions=2, options={'c1': 0.5, 'c2': 0.5, 'w': i})
        optimizer.optimize(goldstein_price, iters=num_iterations)
