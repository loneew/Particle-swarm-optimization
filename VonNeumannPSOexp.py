...
if __name__ == "__main__":
    ...
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GeneralOptimizerPSO(n_particles=num_particles, 
                                    dimensions=2, 
                                    options={'c1': i, 'c2': 0.5, 'w': 0.5, 'p': 2, 'r': 1}, 
    ...
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GeneralOptimizerPSO(n_particles=num_particles, 
                                    dimensions=2, 
                                    options={'c1': 0.5, 'c2': i, 'w': 0.5, 'p': 2, 'r': 1}, 
                                    topology=my_topology)
        optimizer.optimize(goldstein_price, iters=num_iterations)
    ...
    for index, i in enumerate([0, 0.25, 0.5, 0.75, 1]):
        optimizer = GeneralOptimizerPSO(n_particles=num_particles, 
                                    dimensions=2, 
                                    options={'c1': 0.5, 'c2': 0.5, 'w': i, 'p': 2, 'r': 1}, 
                                    topology=my_topology)
        optimizer.optimize(goldstein_price, iters=num_iterations)
