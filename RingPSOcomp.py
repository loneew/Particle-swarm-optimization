...
if __name__ == "__main__":
    ...
    optimizer1 = LocalBestPSO(n_particles=num_particles, dimensions=2, options={'c1': 0.5, 'c2': 0.3, 'w': 0.9, 'k': 3, 'p': 2})
    ...
    optimizer2 = LocalBestPSO(n_particles=num_particles, dimensions=2, options={'c1': 0.5, 'c2': 0.3, 'w': 0.9, 'k': 3, 'p': 2}, bounds=my_bounds)
